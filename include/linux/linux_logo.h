...
extern const struct linux_logo logo_imx_clut224;
extern const struct linux_logo logo_imx1_clut224;

extern const struct linux_logo *fb_find_logo(int depth, int i);
